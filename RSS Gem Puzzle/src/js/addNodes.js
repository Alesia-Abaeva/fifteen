...
// в начальном состоянии игры, рамка заполнена случайно сгенерированными числами, при запуске новой игры числа перетасовываются случайным
// образом, когда вы нажимаете на плитку рядом с пустой ячейкой, плитка перемещается в пустую ячейку
// Передовой:
